...
```bash
curl -X GET "https://api.apiverve.com/v1/whoislookup?param=value" \
...
📚 **Full API Documentation:** [https://docs.apiverve.com/ref/whoislookup](https://docs.apiverve.com/ref/whoislookup)

---

## Use Cases

Common use cases for the WHOIS Lookup API:
